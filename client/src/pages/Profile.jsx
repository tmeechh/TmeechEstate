...
const Profile = () => {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto ">
      <h1 className="text-center text-3xl font-[700] my-7 ">Profile</h1>
      ...
      <div className='my-12 flex items-center text-center justify-center text-lg'>
        
      <Link to='/your-listings' className='underline  text-[14px] lg:text-[16px] text-green-700   '>
                   View Your Listings
                </Link>
                </div>
